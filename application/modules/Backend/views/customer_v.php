            ...
            <div class="card card-custom ">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">
                            <span id="customer_dynamic_title"><?= ucfirst($load_data['site_title']) ?> List</span>
                            <span class="d-block text-muted pt-2 font-size-sm" id="customer_dynamic_subtitle_span">Customers, you are work with</span>
                        </h3>
                    </div>

                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <?php if (in_array(10, $userPermissionArr)) { ?>
                        <button type="button" class="btn btn-primary font-weight-bolder " id="add_customer_button">
                ...
                <div class="card-body">
                    <!--begin: Datatable-->
                    <div class="datatable datatable-bordered datatable-head-custom" id="customer_datatable">
                    </div>
                    <!--end: Datatable-->

                    <!-- begin: Wizard-->
                    <div class="wizard wizard-3 d-none " id="customer_form_model" data-wizard-state="step-first" data-wizard-clickable="true">
                        <!--begin: Wizard Nav-->
