                    ...
                    <div class="card-toolbar d-print-none">
                        ...
                        <a href="<?= base_url('backend/sale'); ?>">
                            <button type="button" class="btn btn-primary font-weight-bolder">
                                <i class="fas fa-file-invoice-dollar"></i> Sale List
                            </button>
                        </a>
                        <!--end::Button-->
                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if (!($load_data['customers'] == '')) { ?>
                                            <?php foreach ($load_data['customers'] as $value) : ?>
                                                <?php if ($value->id == $load_data['sale_data'][0]->customer_id) {
                                                    $value_customer = $value->customer_name;
                                                } ?>
                                        <?php endforeach;
                                        } ?>
                                        <input type="text" name="customer_name" id="customer_name" value="<?= $value_customer ?>" class="form-control" placeholder="Customers" data-fv-not-empty="true" data-fv-not-empty___message="Customer is required">
                                        <input type="hidden" name="customer_id" id="customer_id" value="<?= $load_data['sale_data'][0]->customer_id ?>">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input type="number" name="data[<?= $count; ?>][quantity]" id="quantity_<?= $count; ?>" class="form-control " value="<?= $invoiceItems->quantity; ?>" autocomplete="off" data-fv-not-empty="true" data-fv-not-empty___message="Required" data-fv-integer="true" data-fv-integer___message="Enter valid Qty" data-fv-greater-than="true" data-fv-greater-than___min="1" data-fv-greater-than___message="Minimum 1" data-fv-less-than="true" data-fv-less-than___max="<?= $load_data['item_list'][$selectedItem]->total_quantity  + $invoiceItems->quantity ?>" data-fv-less-than___message="Available <?= $load_data['item_list'][$selectedItem]->total_quantity + $invoiceItems->quantity ?>">
                                                        </div>
                                                    </td>
