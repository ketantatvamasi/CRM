            ...
            <div class="card card-custom ">
                ...
                <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="purchse_date" id="purchse_date" placeholder="Enter invoice number" data-fv-not-empty="true" data-fv-not-empty___message="Bill date is required" />
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="vendor_invoice_no" id="vendor_invoice_no" placeholder="Enter invoice number" data-fv-not-empty="true" data-fv-not-empty___message="The Bill no is required" />
                                </div>
                            </div>
                        </div>
                    ...
                    <div style="float:right;">
                        <input type="reset" id="reset_button" class="btn font-weight-bolder btn-light-primary" />
