							...
							<div class="d-flex align-items-center mb-10">
								...
								<div class="symbol symbol-40 symbol-light-success mr-5">
									<span class="symbol-label">
										<img src="<?= base_url();?>assets/backend/media/svg/avatars/009-boy-4.svg" class="h-75 align-self-end" alt="" />
									</span>
								</div>
								<!--end::Symbol-->
						...
						<div class="card-body pt-0">
							...
							<div class="mb-10">
								...
								<div class="d-flex align-items-center">
									...
									<div class="symbol symbol-45 symbol-light mr-5">
										<span class="symbol-label">
											<img src="<?= base_url();?>assets/backend/media/svg/misc/006-plurk.svg" class="h-50 align-self-center" alt="" />
										</span>
									</div>
									<!--end::Symbol-->
							...
							<div class="mb-10">
								...
								<div class="d-flex align-items-center">
									...
									<div class="symbol symbol-45 symbol-light mr-5">
										<span class="symbol-label">
											<img src="<?= base_url();?>assets/backend/media/svg/misc/015-telegram.svg" class="h-50 align-self-center" alt="" />
										</span>
									</div>
									<!--end::Symbol-->
							...
							<div class="">
								...
								<div class="d-flex align-items-center">
									...
									<div class="symbol symbol-45 symbol-light mr-5">
										<span class="symbol-label">
											<img src="<?= base_url();?>assets/backend/media/svg/misc/014-kickstarter.svg" class="h-50 align-self-center" alt="" />
										</span>
									</div>
									<!--end::Symbol-->
